...
| [`launch-strategy.md`](./launch-strategy.md) | 4-phase launch playbook anchored to sprint deadline 2026-05-18. Day-of channel stack, technical / comms readiness checklist, risk register, demo-day narrative. | Pre-launch (T-6 → T+0) and launch day (T+14, 2026-06-02). |
...
| Doc | Purpose | Read when |
|-----|---------|-----------|
| [`launch-posts.md`](./launch-posts.md) | Pre-written launch-day posts for Product Hunt, Hacker News, IndieHackers, Reddit, LinkedIn, Twitter/X, BetaList, India communities, and email. | Launch day morning (2026-06-02). Edit lightly before posting; copy verbatim only on PH. |
...
| [`demo-script.md`](./demo-script.md) | 4-minute demo-day pitch with minute-by-minute beats, Q&A, and failure fallbacks. Maps 1:1 to business-brief talking points. | Demo day (2026-05-18). Practice T-3, T-2, T-1. |
...
| [`landing-copy.md`](./landing-copy.md) | Landing page copy — 3 hero variants, 8 sections, comparison table, FAQ subset, waitlist form, voice + visual notes. | Building the landing page (T-4, by 2026-05-14). |
...
| Date | Day | Milestone |
|------|-----|-----------|
| 2026-05-12 | Tue | Today (T-6). Strategy docs landed. |
| 2026-05-14 | Thu | Landing page live (T-4). |
| 2026-05-16 | Sat | Launch FAQ + demo script reviewed (T-2). |
| 2026-05-17 | Sun | Runbook + status page wired (T-1). Final dry run. |
| 2026-05-18 | Mon | Sprint demo day (T-0). Soft launch begins same evening. |
| 2026-05-25 | Mon | Soft launch ends (T+7). Tally activations + testimonials. |
| 2026-06-01 | Mon | Public launch IST (T+14 IST). |
| 2026-06-02 | Tue | Public launch PT (T+14 PT). PH go-live 12:01 AM PT. |
| 2026-06-17 | Wed | Post-launch evaluation (T+30). Conversion gates open. |
| 2026-08-16 | Sun | Quarterly review (T+90). Roadmap re-baselined. |
...
- Dates: absolute (`2026-05-18`), never relative (`next Monday`).
